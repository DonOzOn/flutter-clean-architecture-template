...
import 'package:flutter_clean_architecture/preferences/base_preferences.dart';
import 'package:flutter_clean_architecture/preferences/hydrate_storage/hydrated_storage.dart';
import 'package:flutter_clean_architecture/preferences/hydrate_storage/hydrated_storage_implement.dart';
import 'package:flutter_clean_architecture/preferences/user_preference.dart';
...
class AppDependencies {
  ...
  static Future<void> init() async {
    ...
    sl.registerSingleton<BasePreferences>(UserPreference()..initialize());
    sl.registerSingleton<HydratedStoragePreferences>(
        HydratedStoragePreferencesImplement());
    ...
    sl.registerLazySingleton<RegisterRepository>(
        () => RegisterRepositoryImpl(registerApi: sl()));
    sl.registerLazySingleton<GetProductRepository>(
        () => ProductRepositoryImpl(productApi: sl()));
    ...
    sl.registerLazySingleton(
        () => FindAllProductUseCase(getProductRepository: sl()));
    sl.registerLazySingleton(
        () => FindProductByIdUseCase(getProductRepository: sl()));
    sl.registerLazySingleton(
        () => CreateProductUseCase(createProductRepository: sl()));
    sl.registerLazySingleton(
        () => UpdateProductUseCase(updateProductRepository: sl()));
    sl.registerLazySingleton(
        () => DeleteProductUseCase(deleteProductRepository: sl()));
    ...
    sl.registerFactory(() =>
        RegisterBloc(registerUseCase: sl(), sharedPreferenceModule: sl()));
