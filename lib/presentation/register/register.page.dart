...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _handleState(state) {
    if (state is RegisterPageStateLoading) {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, ConfigKeys.ROUTE_HOME, (r) => false);
  ...
  void _doRegister() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.registerBloc
          .add(RegisterPageEventDoRegister(registerRequest: req));
    }
  }
      ...
      child: Form(
          ...
          child: Column(
            children: [
              ...
              PrimaryButton(
                  text: "Create account",
                  onClick: _isLoading ? null : _doRegister)
            ],
          )),
    );
  }
          ...
          child: Container(
            ...
            child: BlocConsumer<RegisterBloc, RegisterPageState>(
              ...
              builder: (context, state) {
                return Column(
                  children: [_headerWidget(), _loadingBar(), _signUpForm()],
                );
              },
            ),
          ),
