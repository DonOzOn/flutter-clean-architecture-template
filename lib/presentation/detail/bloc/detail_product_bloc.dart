...
class DetailProductPageBloc
    extends Bloc<DetailProductPageEvent, DetailProductPageState> {
  ...
  @override
  Stream<DetailProductPageState> mapEventToState(
      DetailProductPageEvent event) async* {
  ...
  Stream<DetailProductPageState> _updateProduct(
      UpdateProductRequest req, String id) async* {
